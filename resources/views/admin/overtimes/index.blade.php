<x-app-layout>
    ...
    <x-slot name="sidebar">
        ...
        <x-nav-link href="{{ route('admin.overtimes.index') }}" :active="true">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @forelse($overtimes as $overtime)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('admin.overtimes.show', $overtime) }}" class="text-blue-600 dark:text-blue-400 hover:underline">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
