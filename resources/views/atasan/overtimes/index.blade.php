<x-app-layout>
    <x-slot name="header">Overtime Requests</x-slot>
    ...
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Overtime Requests</h2>

    <!-- Filter Tabs -->
    <div class="mb-6 flex gap-4">
        <a href="{{ route('atasan.overtimes.index') }}" 
        ...
        <a href="{{ route('atasan.overtimes.index', ['status' => 'pending']) }}" 
        ...
        <a href="{{ route('atasan.overtimes.index', ['status' => 'approved']) }}" 
        ...
        <a href="{{ route('atasan.overtimes.index', ['status' => 'rejected']) }}" 
                ...
                @forelse($overtimes as $overtime)
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-xs text-gray-500 dark:text-gray-400">{{ $overtime->user->employee_id }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('atasan.overtimes.show', $overtime) }}" class="text-blue-600 dark:text-blue-400 hover:underline">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
