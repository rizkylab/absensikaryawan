<x-app-layout>
    ...
    <x-slot name="sidebar">
        ...
        <x-nav-link href="{{ route('atasan.approvals.index') }}" :active="true">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Pending Approvals</h2>

    <!-- Overtime Requests -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow mb-6">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Overtime Requests ({{ $overtimes->count() }})</h3>
        </div>
                    ...
                    @forelse($overtimes as $overtime)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('atasan.overtimes.show', $overtime) }}" 
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Leave Requests ({{ $leaves->count() }})</h3>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-gray-50 dark:bg-gray-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($leaves as $leave)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('atasan.leaves.show', $leave) }}" 
                                   class="text-blue-600 dark:text-blue-400 hover:underline">Review</a>
                            </td>
                        </tr>
                    @empty
